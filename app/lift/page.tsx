  ...
  treatments: [
    {
      name: "糸リフト",
      slug: "thread-lift",
      desc: "独自の吸収糸でたるみを引き上げます。切開不要でダウンタイムが短く、肌質改善やコラーゲン生成効果も期待できます。",
    },
    {
      name: "ショートスレッド",
      slug: "short-thread",
      desc: "極細の短い糸を肌に埋入し、土台から引き締めます。異物リスクを最小限に抑えながら、ハリとツヤが徐々に向上します。",
    },
    {
      name: "アイスレッド",
      slug: "eye-thread",
      desc: "極細糸で目元のコラーゲン増産を促進。切らずに目元の凹みやクマを内側から改善し、明るい表情を取り戻します。",
    },
    {
      name: "MACSフェイスリフト",
      slug: "macs-facelift",
