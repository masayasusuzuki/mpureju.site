...
export function MobileBottomNav() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-[var(--color-brand-dark)] border-t border-white/10">
      <div className="grid grid-cols-4 h-16">
        ...
        >
          ...
          <span className="text-[10px]">LINE相談</span>
        </a>
        ...
        >
          ...
          <span className="text-[10px] font-medium">Web予約</span>
        </a>
        ...
        >
          ...
          <span className="text-[10px]">施術一覧</span>
        </Link>
      </div>
    </div>
  );
