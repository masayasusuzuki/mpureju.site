...
const TABS = [
  {
    ...
    pillarHref: "/mouth",
    treatments: [
      { name: "口角挙上",        desc: "下がった口角を引き上げる",           href: "/mouth/corner-lip-lift" },
      { name: "M字リップ",       desc: "M字型の立体的な唇に",               href: "/mouth/m-shaped-lip" },
      { name: "人中短縮",        desc: "鼻の下をすっきり短く",               href: "/mouth/lip-lift" },
      { name: "口唇縮小",        desc: "厚ぼったい唇を薄く整える",           href: "/mouth/lip-reduction" },
      { name: "ガミースマイル",  desc: "笑ったときの歯茎の見え過ぎを改善",   href: "/mouth/gummy-smile" },
      { name: "口唇拡大",        desc: "唇を自然に厚く見せる",               href: "/mouth/lip-augmentation" },
      { name: "外側人中短縮",    desc: "上唇外側を引き上げ顔の余白を整える",  href: "/mouth/lateral-lip-lift" },
      { name: "ピーナッツリップ", desc: "下唇に立体的なくびれを出す",         href: "/mouth/peanut-lip" },
    ],
  },
  {
    id: "eye",
    ...
    treatments: [
      ...
      { name: "目尻切開",     desc: "切れ長で大きな目元に",             href: "/eye/lateral-canthoplasty" },
      { name: "グラマラス",   desc: "垂れ目で色気のある目元に",         href: "/eye/glamorous" },
      { name: "蒙古襞形成",   desc: "見えすぎた涙丘をさりげなく隠す",   href: "/eye/mongolian-fold" },
    ],
  },
  {
    id: "nose",
    ...
    treatments: [
      ...
      { name: "耳介軟骨移植",         desc: "自家軟骨で自然に形成",          href: "/nose/ear-cartilage" },
      { name: "鼻骨骨切り",           desc: "鼻筋を細くまっすぐに整える",    href: "/nose/osteotomy" },
      { name: "ハンプ切除",           desc: "鷲鼻の出っ張り部分を除去",      href: "/nose/hump-reduction" },
      { name: "鼻孔縁下降",           desc: "鼻の穴のアーチを目立たなく",    href: "/nose/nostril-margin" },
      { name: "鼻翼基部形成（貴族）", desc: "小鼻の付け根に立体感を出す",    href: "/nose/alar-base" },
    ],
  },
  {
    id: "lift",
    ...
    treatments: [
      ...
      { name: "MACSフェイスリフト",    desc: "フェイスラインを自然に引き締める",  href: "/lift/macs-facelift" },
      { name: "SMASフェイスリフト",    desc: "筋膜ごと引き上げ最大限の効果",     href: "/lift/smas-facelift" },
      { name: "ネックリフト",          desc: "首・あごのたるみを改善",           href: "/lift/neck-lift" },
      { name: "脂肪吸引",              desc: "顔の脂肪を吸引してすっきり小顔に", href: "/lift/facial-liposuction" },
      { name: "バッカルファット除去",  desc: "ほほの深部脂肪を取り除く",         href: "/lift/buccal-fat" },
      { name: "脂肪注入",              desc: "自家脂肪でくぼみ・ハリを補う",     href: "/lift/fat-injection" },
    ],
  },
  {
    id: "skin",
    ...
    treatments: [
      ...
      { name: "IPL / フォトフェイシャル", desc: "光でシミ・赤ら顔を総合的に改善",    href: "/skin/ipl" },
      { name: "ピーリング",              desc: "肌のターンオーバーを促し質感アップ", href: "/skin/peeling" },
      { name: "スキンブースター",        desc: "美容成分を肌の奥深くに届ける",       href: "/skin/skin-booster" },
      { name: "脂肪溶解注射",            desc: "脂肪細胞を分解・排出してすっきり",   href: "/skin/fat-dissolving" },
      { name: "サーマジェン（RF）",      desc: "高周波で引き締め・ハリを改善",       href: "/skin/thermagen" },
    ],
  },
];
