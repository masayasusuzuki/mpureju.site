                    ...
                    {results.map((row, i) => (
                      ...
                      >
                        <td className="py-2.5 px-3 text-[10px] text-[var(--color-text-secondary)]/50 whitespace-nowrap w-28">
                          {row.section}
                          {row.subTab ? ` › ${row.subTab}` : ""}
                        </td>
                        <td className="py-2.5 px-3 text-[var(--color-text-primary)] leading-relaxed">
                          {row.category}
                          {row.option && (
                            <span className="ml-1.5 text-[var(--color-text-secondary)]/60">
                              （{row.option}）
                            </span>
                          )}
                        </td>
                        <td className="py-2.5 px-3 text-right font-medium text-[var(--color-brand-dark)] tabular-nums whitespace-nowrap w-24">
                          {row.price}
                        </td>
                      </tr>
                    ))}
